  ...
  Scenario Outline: download full custom op locatie <locatie> voor feature(s): <dkkfeaturetype>
    ...
    * eval db.mywriteln('- Test: T05_<testname>\n'+'  Url: '+downloadlink+'\n  Size: '+zipsize+'\n  Time: '+ LocalDateTime.now() +'\n' , 'target/surefire-reports/fullcustomurl.yaml')
    ...
    Examples:
      ...
      | 8_prodent_fabriek                    | perceel",  "kadastralegrens", "pand", "openbareruimtelabel | Amersfoort Prodent Fabriek | POLYGON((154125.82490221905754879 463344.15998090390348807, 154404.92781473969807848 463761.69793803477659822, 154804.60318546460.26679251249879599, 154447.35145744285546243 463040.4960120814503170928465366 4635, 154125.82490221905754879 463344.15998090390348807)) |