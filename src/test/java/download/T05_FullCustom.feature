  ...
  Scenario Outline: download full custom op locatie <locatie> voor feature(s): <dkkfeaturetype>
    ...
    * eval db.mywriteln('- Test: T05_<testname>\n'+'  Url: '+downloadlink+'\n  Size: '+zipsize+'\n  Time: '+ LocalDateTime.now() +'\n' , 'target/surefire-reports/fullcustomurl.yaml')
    ...
    Examples:
      ...
      # bug | 8_prodent_fabriek                    | perceel",  "kadastralegrens", "pand", "openbareruimtelabel | Amersfoort Prodent Fabriek | Polygon ((154125.82490221905754879 463344.15998090390348807, 154404.92781473969807848 463761.69793803477659822, 154804.60318546928465366 463460.26679251249879599, 154447.35145744285546243 463040.49601208145031705, 154125.82490221905754879 463344.15998090390348807)) |
      # add test for error in wkt coordinate typo
      | 8_prodent_fabriek                    | perceel",  "kadastralegrens", "pand", "openbareruimtelabel | Amersfoort Prodent Fabriek | POLYGON ((154125.82490221905754879 463344.15998090390348807, 154404.92781473969807848 463761.69793803477659822, 154804.60318546928465366 463460.26679251249879599, 154447.35145744285546243 463040.49601208145031705, 154125.82490221905754879 463344.15998090390348807)) |
