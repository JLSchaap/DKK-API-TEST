...
Feature: DKK WMS geeft map  V4
  ...
  Scenario Outline: WMS geef voor <toepassing> laag met legenda <legenda tekst> <type> <bbox> <width> <height>
    ...
    * eval karate.embed(responseBytes,'image/png')
    ...
    Examples:
      | test | bbox    | width | height | v4layer               | v3style                                                     | toepassing | LaagnaamV4         | symbool                        | legenda tekst         | MinScale | MaxScale | kleur           | type                                              |
      ...
      | 3    | box2_BH | 600   | 600    | Nummeraanduidingreeks | kadastralekaartv3:gbkn_annotatie_kadastraal                 | scherm     | Bebouwing          | Nummeraanduidingreeks          | Huisnummer            | 100      | 5001     | rood            | huisnummer (reeks) tekst 8                        |
      | 4    | box2_BH | 4000  | 4000   | Nummeraanduidingreeks | kadastralekaartv3:gbkn_annotatie_kadastraal_print           | print      | Bebouwing          | Nummeraanduidingreeks          | Huisnummer            | 50       | 2550     | rood            | huisnummer (reeks) tekst 14                       |
      | 5    | box2_BH | 600   | 600    | Nummeraanduidingreeks | kadastralekaartv3:gbkn_annotatie_kadastraal                 | scherm     | OpenbareRuimteNaam | ORLweg                         | Straatnaam            | 100      | 2001     | tekst           | zwart tekst 10  (openbareRuimteType=Weg recht     |
      | 6    | box2_BH | 4000  | 4000   | Nummeraanduidingreeks | kadastralekaartv3:gbkn_annotatie_kadastraal_print           | print      | OpenbareRuimteNaam | ORLweg                         | Straatnaam            | 50       | 1050     | tekst           | zwart tekst 20  (openbareRuimteType=Weg recht     |
      | 7    | box2_BH | 600   | 600    | Nummeraanduidingreeks | kadastralekaartv3:gbkn_annotatie_kadastraal                 | scherm     | OpenbareRuimteNaam | ORLwater                       | Waternaam             | 100      | 2001     | tekst           | zwart tekst 10  (openbareRuimteType=Water italic) |
      | 8    | box2_BH | 4000  | 4000   | Nummeraanduidingreeks | kadastralekaartv3:gbkn_annotatie_kadastraal_print           | print      | OpenbareRuimteNaam | ORLwater                       | Waternaam             | 50       | 1050     | tekst           | zwart tekst 20  (openbareRuimteType=Water italic) |
